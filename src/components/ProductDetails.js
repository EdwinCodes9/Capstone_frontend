...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = () => {
    navigate("/inbox?conversation=1247489048840400");
  };
...
const ProductDetailsInfo = ({ data }) => {
  ...
  return (
    <div className="bg-[#f7fbf5] px-3 800px:px-10 py-2 rounded">
        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            ...
            <p className="pt-2">
              ...
              euismod, nisl ut tristique semper, mauris velit venenatis felis,
              at pharetra dolor odio ac arcu. Aenean ultrices risus ut nulla
              pellentesque hendrerit. Sed vel faucibus tellus. Suspendisse
              potenti. Maecenas eget ullamcorper
            </p>
          </div>
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
            <div className="text-left">
                <h5 className="font-[600] ">
                    Joined On: <span className="font-[500]">26 April,2023</span>
                </h5>
